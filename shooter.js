...
var imageRepository = new function() {
	...
	this.spaceship.src = "imgs/ship3.png";
...
function Ship() {
	 ...
	 */
	this.fire = function() {
		this.bulletPool.get(this.x+25, this.y, 3);
		game.bullts--;
	};
}
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.shipStartX = 0;
			this.shipStartY = 360 - imageRepository.spaceship.height;
 ...
 */
function animate() {
	score.value = game.playerScore;
	bullts.value = game.bullts;
	...
	if (game.bullts < 0 && game.playerScore < 70) {
		game.gameOver();
	}
	else if (game.playerScore >= 70) {
		game.victory();
	}
	else {
